...
config = PyaroConfig(
    ...
    filters={"variables": {"include": ["pm10#elemental_carbon#ug C m-3", "pm10#organic_carbon#ug C m-3"]}},
    name_map={"pm10#elemental_carbon#ug C m-3": "elementalcarbon", "pm10#organic_carbon#ug C m-3": "organiccarbon"},
)
...
PYARO = dict(
        ...
        obs_vars=["elementalcarbon", "elementalcarbon"],            # List of variables that is to be evaluated
        obs_vert_type="Surface",                                     # Observation level
        ts_type="monthly",                                          # Frequency of read observations. Evaluation can not be finer than this, for this network
    )
